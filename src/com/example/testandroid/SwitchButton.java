...
public class SwitchButton extends CompoundButton {
	...
	protected void drawableStateChanged() {
		...
		Log.e(MainActivity.tag, "479/"+ste.getFileName()+" ,in "+ste.getMethodName());
	}
		...
		switch (action) {
			...
			case MotionEvent.ACTION_UP:
				...
				if (deltaX < mTouchSlop && deltaY < mTouchSlop && time < mClickTimeout) {
					...
					Log.e(MainActivity.tag, "521/"+ste.getFileName()+" ,in "+ste.getMethodName()+ " MotionEvent.ACTION_UP");
				} else {
					if (nextStatus != isChecked()) {
						playSoundEffect(SoundEffectConstants.CLICK);
						setChecked(nextStatus);
						Log.e(MainActivity.tag, "526/"+ste.getFileName()+" ,in "+ste.getMethodName()+ " MotionEvent.ACTION_UP");
					} else {
						animateToState(nextStatus);
						Log.e(MainActivity.tag, "529/"+ste.getFileName()+" ,in "+ste.getMethodName()+ " MotionEvent.ACTION_UP");
					}
				}
				break;
	...
	public boolean performClick() {
		StackTraceElement ste= Thread.currentThread().getStackTrace()[2];
		Log.e(MainActivity.tag, "569/"+ste.getFileName()+" ,in "+ste.getMethodName());
	...
	public void setCheckedImmediately(boolean checked) {
		...
		invalidate();
		StackTraceElement ste= Thread.currentThread().getStackTrace()[2];
		Log.e(MainActivity.tag, "620/"+ste.getFileName()+" ,in "+ste.getMethodName());
	}

	public void toggleImmediately() {
		setCheckedImmediately(!isChecked());
		StackTraceElement ste= Thread.currentThread().getStackTrace()[2];
		Log.e(MainActivity.tag, "626/"+ste.getFileName()+" ,in "+ste.getMethodName());
	}
